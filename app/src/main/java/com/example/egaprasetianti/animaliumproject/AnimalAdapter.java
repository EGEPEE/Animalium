package com.example.egaprasetianti.animaliumproject;
...
/**
 * Created by Ega Prasetianti on 5/7/2017.
 */
...
public class AnimalAdapter extends RecyclerView.Adapter<AnimalAdapter.MyViewHolder> {
    ...
    public AnimalAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.listlayout,parent,false);
